        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if file_key not in st.session_state.get('file_cache', {}):
                    ...
                    #vectorstore = Chroma.from_documents(pages, UpstageEmbeddings(model="embedding-passage"))
                    vectorstore = Chroma.from_documents(
                    pages, 
                    UpstageEmbeddings(model="embedding-passage"),
                    persist_directory="./chroma_db"  # 예: 현재 작업 디렉토리에 chroma_db 폴더를 만듬
                    )
                    ...
                    # 프롬프트, 메세지 기록 (문맥 정보), 사용자의 질문으로 프롬프트가 구성됨. 
                    ...
                    개인 건강상담용 모델입니다. 건강에 대한 정보를 전달해주세요.
...
# 웹사이트 제목
st.title("RAG를 활용한 개인 건강상담용 LLM")
